/* =====================================================================
   Adil Business Solutions — Company Registry
   ---------------------------------------------------------------------
   Add one entry per client here. Each entry needs:
     name  — shown in the login dropdown
     url   — the deployed Google Apps Script Web App URL for that client
   ===================================================================== */

window.ABS_COMPANIES = [
  {
